...
namespace LykkeWallet.Pages
{
    ...
    public partial class SettingsPage : ContentPage
    {
        ...
        private async void BaseAssetCellTapped(object sender, EventArgs e)
        {
            await Navigation.PushModalAsync(new BaseAssetSelectionPage(this));
        }

        private async void PersonalDataCellTapped(object sender, EventArgs e)
        {
            await Navigation.PushModalAsync(new PersonalDataInfoPage());
        }
