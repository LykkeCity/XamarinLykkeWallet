...
namespace LykkeWallet.CustomUI
{
    class HistoryCell : ViewCell
    {
        ...
        public HistoryCell()
        {
            ...
            _labelAction.SetBinding(Label.TextProperty, new Binding("Amount"));
            _labelDate.SetBinding(Label.TextProperty, new Binding("Date"));
            _labelAmount.SetBinding(Label.TextProperty, new Binding("Amount"));

            var stackLayout = new StackLayout {Orientation = StackOrientation.Horizontal, Padding = new Thickness(5, 0, 5, 0)};
            var leftStackLayout = new StackLayout {Orientation = StackOrientation.Vertical, VerticalOptions = LayoutOptions.Start, Spacing = 0, Padding = new Thickness(0, 7, 0, 7)};
